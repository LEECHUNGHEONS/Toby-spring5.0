...
import main.vol1_chlee.ch7.AppContext;
...
public class UserDaoTest {
	...
	public void setUp() {	
		...
		this.user1 = new User("gyumee", "gyumee", "springno1", "user1@ksug.org", Level.BASIC, 1, 0);
		this.user2 = new User("leegw700", "leegw700", "springno2", "user2@ksug.org", Level.SILVER, 55, 10);
		this.user3 = new User("bumjin", "bumjin", "springno3", "user3@ksug.org", Level.GOLD, 100, 40);
	}
