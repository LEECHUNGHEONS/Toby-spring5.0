package main.vol1_chlee.ch7.learningtest.spring.embeddeddb;
...
public class EmbeddedDBTest {
	...
	public void setUp() {
		...
		db = new EmbeddedDatabaseBuilder()
				 .setType(H2)
				 .addScript("classpath:/main/vol1_chlee/ch7/learningtest/spring/embeddeddb/schema.sql")
				 .addScript("classpath:/main/vol1_chlee/ch7/learningtest/spring/embeddeddb/data.sql")
				 .build();
